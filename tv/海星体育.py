...
class Spider(Spider):
    ...
    def liveContent(self, url):
        ...
        headers = {
            ...
            'Referer': 'https://hxty9.com/',
        }

        try:
            response = requests.get('https://hxty9.com/live', headers=headers, timeout=10)
            ...
            exif = f'#EXTINF:-1 tvg-name="海星体育" group-title="海星体育",海星体育'
            m3u_content.extend([exif, "海星体育"])
            for card in cards:
                ...
                extinf = f'#EXTINF:-1 tvg-name="{title}" group-title="海星体育",{title}'
                ch_url = f"video://https://hxty9.com/live/{live_id}"
    ...
    def localProxy(self, params):
        ...
        return [302, "text/plain", None, {'Location': 'https://sf1-cdn-tos.huoshanstatic.com/obj/media-fe/xgplayer_doc_video/mp4/xgplayer-demo-1080p.mp4'}]
